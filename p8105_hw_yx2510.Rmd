...
* `r nrow(distinct(brfss_prop_data, state_county))` of unique locations are included in the dataset. The answer to whether all of the states are presented is `r all_state`. The state with the most record is `r max_state$state`.
...
ggplot(ny_queen_excel, aes(x = year, y = proportion, color = state_county)) +
        ggtitle("“Excellent” response values in New York County and Queens County from 2002 to 2010") +
        geom_point(size = 2) +
